    ...
    <>
     <div className="univarsal_div">
        <div className="container">
          ...
          <HeroText heroText={{text1:'Our', text2:'Team', description:'Our team of passionate and experienced professionals is dedicated to helping your business achieve its digital goals. We combine expertise in Management, Marketing, Development, Design, and Listing to deliver exceptional results.'}}/>
