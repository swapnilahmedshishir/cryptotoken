  ...
  return (
    ...
    <div className="univarsal_div">
        <div className="container">         
          <HeroText heroText={{ text1:'CONTACT', text2:'US', description:""}}/>
    ...
    <div className="contactus_text_section">
          <div className="row">
            <div className="col-sm-12 col-md-6 contactus_text_div">
              ...
              Let us know details&#34; is informative, consider a more action-oriented phrase like &#34;Get Your Free Crypto Marketing Strategy&#34; or &#34;Start Your Crypto Marketing Journey Today.
              </p>
    ...
    <input type="text" id="fullName" name="fullName" placeholder="Full Name *"  className="contactus_input_fild"/>
    <input type="tel" id="phoneNumber" name="phoneNumber" placeholder="Phone Number *" className="contactus_input_fild"/>
    <input type="email" id="email" name="email" placeholder="Work Email *" className="contactus_input_fild"/>
    <input type="text" id="emailSubject" name="subject" placeholder="Subject" className="contactus_input_fild"/>
