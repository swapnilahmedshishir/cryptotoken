...
const TeamMemberCard = (props) => {
  const {avator, name , position ,description,likdeProfile,twProfile,fbProfile } = props.temMemberDetails ;
              ...
              <div className="services_col_div_style">
                <div className="team_col_text_style">
                  <div className="team_col_image_circle_style">
                    <img
                      src={`/Images/profileImage/${avator}`}
                      alt="keyVector1"
                    />
                  </div>
                  ...
                  <div className="social_media">
                    ...
                    <a
                    href={`https://www.facebook.com/${fbProfile}`}
                      target="_blank"
                    >
                      <FaXTwitter className="bx bxl-twitter" />
                    </a>
                    <a
                    href={`https://www.twitter.com/${twProfile}`}
                    >
