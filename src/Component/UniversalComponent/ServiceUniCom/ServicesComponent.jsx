...
const ServicesComponent = (props) => {
    ...
    useEffect(() => {
        const container = document.querySelector(".servicesComponent_section_image");
        ...
        <div>
          <div className="row about_row_style">
            ...
            <div className="col-sm-12 col-md-6 about_col_text_style col_text_style"> 
              <h2 className="servicesComponent_text_heading">
             {title}
              </h2>

              <p className='servicesComponent_text_para'>
              {text}
