              ...
              <div className="accordion">
                ...
                <FaqItem
                  accordion={{
                    ...
                    content:
                      "Blockchain is a digital record that keeps track of activities safely and openly across a decentralised network of computers. This lets people do business with each other directly, without the need for middlemen.",
                  }}
                />
                ...
                <FaqItem
                  accordion={{
                    ...
                    content:
                      "TOJO Global offers many different marketing services, such as strategy planning, digital marketing campaigns, content creation, branding projects, and social media management. We use data-driven insights and new strategies to improve campaign performance and get measurable results for our clients in a wide range of industries. Our goal is to get people to connect with and stay loyal to our brands.",
                  }}
                />
              </div>
            </div>
